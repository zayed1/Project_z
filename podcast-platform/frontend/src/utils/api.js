...
export const adminAPI = {
  ...
  compareEpisodes: (ids) => api.post('/admin/episodes/compare', { episode_ids: ids }),
  getFilteredRatings: (params) => api.get('/admin/ratings', { params }),
  deleteRating: (id) => api.delete(`/admin/ratings/${id}`),
  getScheduledPosts: () => api.get('/admin/scheduled-posts'),
  createScheduledPost: (data) => api.post('/admin/scheduled-posts', data),
  deleteScheduledPost: (id) => api.delete(`/admin/scheduled-posts/${id}`),
